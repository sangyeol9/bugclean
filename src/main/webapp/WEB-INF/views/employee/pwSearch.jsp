                                    ...
                                    <div class="auth-form">
                                                        ...
                                                        <div class="basic-form">
                                                            <form>
                                                                ...
                                                                <div class="col-sm-12 pt-4 pb-1" style="text-align: center;">
                                                                    <button type="submit"
                                                                        class="btn btn-primary" style="height: 35px;">확인</button>
                                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h4 class="card-title" style="font-weight: bolder;">이메일로 임시비밀번호 받기</h4>
                                                    </div>
                                                    <div class="card-body">
                                                            ...
                                                            <form>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="form-row ml-3">
                                                                            <div class="form-group row">
                                                                                <input type="text" class="form-control col-3" name="email" maxlength="4">
                                                                                @
                                                                                <input type="text" class="form-control col-3"  name="email" maxlength="4">
                                                                                <select id="domain" name="email" class="form-control col-3">
                                                                                    <option selected="" value="">-직접입력-</option>
                                                                                    <option value="naver.com">네이버</option>
                                                                                    <option value="nate.com">네이트</option>
                                                                                    <option value="gmail.com">G메일(구글)</option>
                                                                                </select>&emsp;-&emsp;
                                                                            </div>
                                                                        </div>
                                                                    </div>
