				...
				<div class="modal-content">
					...
					<p id="modal-content"></p>
						...
						<div class="input-group flex-nowrap mt-2">
							...
							<c:if test="${info.DEP_NAME eq '현장팀' || info.DEP_NAME eq '사업부'  || info.DEP_NAME eq '사장'}">
							...
							<c:if test="${info.DEP_NAME ne '현장팀' && info.DEP_NAME ne '사업부'  && info.DEP_NAME ne '사장'}">
						...
						<c:if test="${info.DEP_NAME eq '현장팀' || info.DEP_NAME eq '사업부' || info.DEP_NAME eq '영업팀' || info.DEP_NAME eq '사장' }">
						...
						<c:if test="${info.DEP_NAME ne '현장팀' && info.DEP_NAME ne '사업부' && info.DEP_NAME ne '영업팀' && info.DEP_NAME ne '사장' }">
