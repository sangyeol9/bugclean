			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title">내 결재중 문서</h4>
					</div>
					<div class="card-body">
						...
						<ul class="pagination justify-content-center">
							...
							<c:if test="${!pager.start}">
								<li class="page-item"><a class="page-link"
									href="./myapprovinglist?page=${pager.lastNum+1}">Previous</a></li>
							</c:if>
							...
							<c:forEach begin="${pager.startNum}" end="${pager.lastNum}"
								var="i">
								<li class="page-item"><a class="page-link"
									href="./myapprovinglist?page=${i}">${i}</a></li>
							</c:forEach>

							<!-- 다음@@@@@@@@@@@@@@@ -->
							<c:if test="${!pager.last}">
								<li class="page-item"><a class="page-link"
									href="./myapprovinglist?page=${pager.lastNum+1}">Next</a></li>
							</c:if>
						</ul>
					</nav>
				</div>
